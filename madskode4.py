...
def on_connect_player1(client, userdata, flags, rc):
    client.subscribe("f20v/Player2", 0)

def on_connect_player2(client, userdata, flags, rc):
    client.subscribe("f20v/Player1", 0)
