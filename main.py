...
def mqtt_receive_workout():
    ...
    def on_message(client, userdata, msg):
        ...
        if ("silas/test" in msg.topic):
            if ("Crunches" in str(msg.payload)):
                oled_write("Crunches")
                number = 1
                while number == 1:
                    if button_yes.is_pressed:
        ...
        if ("silas/test" in msg.topic):
            if ("Bicycle Crunches" in str(msg.payload)):
                oled_write("Crunches")
                number = 1
                while number == 1:
                    if button_yes.is_pressed:
        ...
        if ("silas/test" in msg.topic):
            if ("High Knees" in str(msg.payload)):
                oled_write("High Knees")
                number = 1
                while number == 1:
                    if button_yes.is_pressed:
                        mqtt_write("yes")
